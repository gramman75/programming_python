...
def check(line):
    ...
    hard_code = ['89','101','2022','M01','V01','M00','M01','M02','M03','M04','M05','LSIS_KR_OU','LSIS_KR_GL_COSTCENTER','KRW','USD','LSIS_KR_TAN_CO','LSIS_KR_INT_CO','LSIS_KR_DEPOSIT','LSIS_KR_FIN_LEDGER']
...
textList = glob.glob('d:\\check\\*.*')
target_dir = 'd:\\result\\'
suffix = 'hc_'

for textName in textList:
    file_name = textName[9:]
    print textName
    i = 0
    lineNum = 0
    f = open(textName,'r')
